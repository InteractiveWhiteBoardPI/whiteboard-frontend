...
import FileBubble from "../file-bubble/file-bubble.component";


const ChatBubble = ({ message, isSender, isSession}) => {
  ...
  return (
    <div className="flex w-full h-full">
      ...
      >
        {isClicked && isSender && !isSession && <DeleteSingleMessageModal messageId={message.id}/>}
        ...
        {isClicked && !isSession && !isSender && <DeleteSingleMessageModal messageId={message.id}/>}
      </div>
    </div>
  );
